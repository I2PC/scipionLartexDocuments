 ...
 \begin{figure}[H]
   ...
   \begin{itemize}
    ...
    \begin{itemize}
     ...
     \begin{itemize}
      \item \ttt{Chain}: Specific chain that has to be extracted. The wizard on the right helps the user to select that chain, indicating the number of the starting model structure and the number of chain residues.
      \item \ttt{Start at residue \#}: By default value is -1 if you want to extract the whole chain. In case you would like to extract only a fraction of the chain, the number of the initial required residue should be indicated. 
      \item \ttt{End at residue \#}: By default value is -1 if you want to extract the whole chain. In case you would like to extract only a fraction of the chain, the number of the last required residue should be indicated. 
     \end{itemize}
