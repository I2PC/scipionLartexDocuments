...
\begin{figure}[H]
  ...
  \caption{\scipion framework detailing the workflow to generate the first model of human \ttt{Hgb} $\alpha$ subunit.}
...
In a similar process, you can also obtain human \ttt{metHgb} $\beta$ subunit.\\
