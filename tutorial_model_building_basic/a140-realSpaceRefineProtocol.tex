...
\begin{itemize}
 ...
 \item Protocol form parameters (\ffigure{fig:app_protocol_real_space_refine_1} (B)):\\
    ...
    \begin{itemize}
     ...
     \item \ttt{Macro cycles}: Advanced param that allows select the number of iterations of refinement. Although 5 macro-cycles, set by default, is enough, increasing this value might be helpful when model geometry or/and model-to-map fit is poor. Incrementing the number of macro-cycles will also escale the computing times.
