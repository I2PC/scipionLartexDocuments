...
\begin{itemize}
 ...
 \\If it is installed, a help page will appear. Otherwise, type in the command line:\\ \\ \ttt{devel install /path\_to\_scipion3\_plugins/scipion-em-chimera/chimera/Bundles/scipion}\\ 
