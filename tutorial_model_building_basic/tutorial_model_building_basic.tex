...
Density for amino acid side chains from an experimental electron density map at 1.5 \AA~resolution \footnotesize{(http://people.mbi.ucla.edu/sawaya/m230d/Modelbuilding/modelbuilding.html)\end{center}
...
\begin{versionhistory}
  \vhEntry{1.0}{15.11.2018}{MM|RM}{created for first model building workshop}
  \vhEntry{1.1}{30.01.2019}{MM}{added appendices and minor fixes}
  \vhEntry{1.2}{24.04.2019}{MM}{added atomstructutils, contacts and submission protocols}
\end{versionhistory}\newpage
