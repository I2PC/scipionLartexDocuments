(function($) {
  ...
  $.widget("ui.suma_slider", $.ui.ae_slider, {
    options: {
    },
    ...
    _create: function() {
      ...
      $.ui.suma_slider.instances.push(this.element);
    ...
    _destroy: function() {
      ...
      var position = $.inArray(element, $.ui.suma_slider.instances);

      /* If this instance was found, splice it off */
      if(position > -1){
        $.ui.suma_slider.instances.splice(position, 1);
      }
    },
    ...
    _getOtherInstances: function() {
      ...
      return $.grep($.ui.suma_slider.instances, function(el) {
        return el !== element;
      });
    },
