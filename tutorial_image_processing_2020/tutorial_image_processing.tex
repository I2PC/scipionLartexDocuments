...
This tutorial requires, in addition to \scipion, \textit{cryoSPARC2} (\url{https://cryosparc.com/}). It is \textbf{IMPORTANT} to remark that for executing any \textit{cryoSPARC2} protocol, in the compute settings \scommand{tab}, the option \ttt{Cache particle images on SSD} has to be \textbf{deactivated}. 
