...
After executing this protocol, we can visualize the list of 30 movies imported to the project by pressing \scommand{Analyze Results}. Each movie contains 50 frames (size 3710 pixels x 3838 pixels). Frames contained in each movie can be visualized by right-clicking each entry.
